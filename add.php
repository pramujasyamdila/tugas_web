...
<body>
   ...
   <div class="container">
      ...
      <form action="add.php" method="post">
         ...
         <div class="form-group">
            ...
            <input type="date" class="form-control" name="tgl_publis">
         </div>
         <div class="row">
            <div class="col-md-6">
   ...
   if (isset($_POST['Submit'])) {
      ...
      $sql = mysqli_query($db, "INSERT INTO trx_berita(id_kategori,judul_berita,penulis,isi_berita,tgl_publis) VALUES('$id_kategori','$judul_berita','$penulis','$isi_berita','$tgl_publis')");
